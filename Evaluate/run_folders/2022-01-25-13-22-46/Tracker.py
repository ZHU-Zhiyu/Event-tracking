...
class Event_tracker(Module):
    ...
    def _forward_with_template(self,X,GT=None):
        ...
        prob_phy = self.tracking_net._regress_phy_pro(Warpped_pos, self.pred2curr_box[None,:].clone())
        ...
        Bbox_output, bbox_all, out_prob = self.tracking_net._weight_cal_box_test(Emb_X, prob_sem, prob_phy, X_pos)
        ...
        return Pred_bbox_final[:,None,:], Pred_bboxs, prob_phy, X_pos
