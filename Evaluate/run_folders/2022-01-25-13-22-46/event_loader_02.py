...
#                             'bicycle-7', 'bicycle-9', 'bicycle-18', 'bird-2', 'bird-3', 'bird-15', 'bird-17', 'boat-3', 'boat-4', 'boat-12', 'boat-17', 'book-3', 'book-10','book-11]
        ...
        self.test_crop = 40
        train_name_file = '/home/zhu_19/saved_mat/FE108/train.txt'
        ...
        match_file = '/home/zhu_19/saved_mat/FE108/pair.txt'
        start_frame_ = {}
    ...
    def __len__(self):
        if self.TM == 'Train':
            ...
            for name_i in self.test_names:
                ...
                # temp_path = temp_path00+ name_i.split('-')[0] + '/' + name_i
                try:
                    gt_bbox = np.loadtxt('/home/zhu_19/saved_mat/'+name_i+'/groundtruth_rect.txt',delimiter=',')
                except:
    ...
    def _update_template(self,name):
        ...
        try:
            f1 = AedatFile('/home/zhu_19/saved_mat/'+name+'/events.aedat4')
            gt_bbox = np.loadtxt('/home/zhu_19/saved_mat/'+name+'/groundtruth_rect.txt',delimiter=',')
        except:
